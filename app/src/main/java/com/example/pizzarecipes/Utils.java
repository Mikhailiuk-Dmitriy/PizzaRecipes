...
public class Utils {
    ...
    public static final String PIZZA_2_DESCRIPTIONS = "Even a novice cook can master the art of pizza with our simple step-by-step guide. Bellissimo";
    ...
    public static final String PIZZA_3_TITLE = "Caramelised onion & goat's cheese pizza";
    public static final String PIZZA_3_DESCRIPTIONS = "Make a veggie pizza that's healthy and low-fat instead of ordering a takeaway.";
    ...
    public static final String PIZZA_4_TITLE = "Superhealthy pizza";
    public static final String PIZZA_4_DESCRIPTIONS = "The quantities for this are generous, so if you have any leftovers, pop a wedge of cold pizza into your lunchbox the next day";
    public static final String PIZZA_4_RECIPE = "Mix the flours and yeast with a pinch of salt in a food processor fitted with a dough blade. Pour in the water and mix to a soft dough, then work for 1 min. Remove the dough and roll out on a lightly floured surface to a round about 30cm across. Lift onto an oiled baking sheet.\n" +
            "\n" +
    ...
    public static final String PIZZA_5_TITLE = "Frying pan pizza";
    public static final String PIZZA_5_DESCRIPTIONS = "Not good for you? Think again, this easy to make pizza is low fat and full of calcium";
    public static final String PIZZA_5_RECIPE = "Heat oven to 220C/fan 200C/gas 7. Place the pepper, courgette and red onion on a large non-stick baking tray and drizzle with 1 tsp olive oil. Season well and toss to combine. Roast in the oven for 20 mins until soft and beginning to brown. Set aside.\n" +
            "\n" +
    ...
    public static final String PIZZA_6_TITLE = "Egg & rocket pizzas";
    public static final String PIZZA_6_DESCRIPTIONS = "Use seeded tortillas as pizza bases for a quick and healthy lunch - crack an egg in the centre and bake to boost protein intake";
    public static final String PIZZA_6_RECIPE = "Heat oven to 200C/180C fan/gas 6. Lay the tortillas on two baking sheets, brush sparingly with the oil then bake for 3 mins. Meanwhile chop the pepper and tomatoes and mix with the tomato purée, seasoning and herbs. Turn the tortillas over and spread with the tomato mixture, leaving the centre free from any large pieces of pepper or tomato.\n" +
            "\n" +
    ...
    public static final String PIZZA_7_TITLE = "Sourdough pizza";
    public static final String PIZZA_7_DESCRIPTIONS = "Make homemade sourdough pizza with a wonderfully chewy crust. Try our margherita recipe, then customise with your favourite toppings";
    ...
    public static final String PIZZA_8_TITLE = "Chicken tikka masala pizzas";
    public static final String PIZZA_8_DESCRIPTIONS = "Rustle up our spiced chicken pizzas using naan bread in just 20 minutes.";
    public static final String PIZZA_8_RECIPE = "Heat oven to 180C/160C fan/gas 4. Toss the red onion with the red wine vinegar and a good pinch of salt and set aside (the vinegar will soften the onion slightly, which is a blessing as no one wants completely raw onion on pizza).\n" +
            "\n" +
    ...
    public static final String PIZZA_9_TITLE = "Ultimate pizza Margherita";
    public static final String PIZZA_9_DESCRIPTIONS = "Take your senses on a trip to Italy with this authentic pizza Margherita";
    public static final String PIZZA_9_RECIPE = "In a bowl, mix flour, semolina, salt and yeast. Make a dip in the middle, pour in oil, water, then stir and squeeze everything together (hands are easiest for this). The dough should feel very sticky (pic 1). When it is well mixed, cover and leave for 15 mins.\n" +
            "\n" +
    ...
    public static final String PIZZA_10_TITLE = "Pizza with homemade sauce";
    public static final String PIZZA_10_DESCRIPTIONS = "Make pizza for the family with a homemade base and tomato sauce. The recipe is perfect to get kids involved in cooking.";
    public static final String PIZZA_10_RECIPE = "Tip the flour into a bowl, then stir in the yeast and 1 tsp salt. Make a well in the centre and pour in 200ml warm water (make sure it’s not too hot) along with the oil. Stir together with a wooden spoon until you have a soft, fairly wet dough.\n" +
            "\n" +
